...
from app.resources.article.following import UserFollowingResource, UnUserFollowingResource
...
article_api.add_resource(UnUserFollowingResource, '/user/followings/<int:target>')
# /app/comments
